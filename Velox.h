...
For use in Velox plugins. Calling these methods after -initWithFrame won't have any effect, you need to call them in your plugins -initwithFrame: method.
 ...
 Using any undocumented methods of the Veliox classes is not supported and will result in undefined behavior. If you have API requests, contact us at support@apextweaks.com.
 Copyright Apextweaks 2013.*/

#import <Foundation/Foundation.h>
@class UIImage, SBIconView;
